...
const size_t print_delay = 20;

const uint8_t channel = 0;

const uint8_t physical_channel_count = 5;
const MPR121::ProximityMode proximity_mode = MPR121::PROXIMITY_MODE_DISABLED;
//MPR121::COMBINE_CHANNELS_0_TO_1;

const uint8_t touch_threshold = 100;
const uint8_t release_threshold = 100;
...
const MPR121::SecondFilterIterations second_filter_iterations = MPR121::SECOND_FILTER_ITERATIONS_18;
const MPR121::SamplePeriod sample_period = MPR121::SAMPLE_PERIOD_1MS;

const uint8_t FILTER_WINDOW_SIZE = 10;
const uint16_t setupTime = 5000;
}